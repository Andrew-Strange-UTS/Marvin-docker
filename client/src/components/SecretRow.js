      ...
      <td style={{ padding: 8 }}>
        {editMode ? (
          <form onSubmit={handleUpdate} style={{ display: "inline-flex", gap: "6px" }}>
            ...
            />
            <button type="submit" style={{ padding: "4px 10px", fontSize: "13px", background: theme.primary, color: theme.primaryText, border: "none", borderRadius: 4 }}>Set</button>
          ...
          <>
            <button
              ...
              style={{ padding: "4px 10px", marginRight: 5, fontSize: "13px", background: theme.primary, color: theme.primaryText, border: "none", borderRadius: 4, cursor: "pointer" }}
            >Edit</button>
            <button
